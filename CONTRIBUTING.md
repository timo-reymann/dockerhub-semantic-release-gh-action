# Contributing to dockerhub-semantic-release-gh-action
...
In short, when you submit code changes, your submissions are understood to be under the same [MIT License](https://github.com/timo-reymann/timo-reymann/dockerhub-semantic-release-gh-action/blob/main/LICENSE) that covers the project. Feel free to contact the maintainers if that's a concern.
